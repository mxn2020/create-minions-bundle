...
export function buildVariables(config) {
    ...
    return {
        ...
        sdkName: `@mxn2020/${config.projectName}-core`,
        cliName: `@mxn2020/${config.projectName}-cli`,
        docsName: `@mxn2020/${config.projectName}-docs`,
        blogName: `@mxn2020/${config.projectName}-blog`,
        webName: `@mxn2020/${config.projectName}-web`,
